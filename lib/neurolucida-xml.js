(function() {
  ...
  NeurolucidaXML = (function() {
    ...
    NeurolucidaXML.prototype.loadTree = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        switch (tree.getAttribute('type')) {
          case 'Axon':
            _results.push(this.loadAxon(tree));
            break;
          case 'Dendrite':
            _results.push(this.loadDendrite(tree));
            break;
          default:
    ...
    NeurolucidaXML.prototype.loadDendrite = function(tag) {
      var child, dendrite, end, index, next, segment, spine, start, _i, _j, _len, _len1, _ref, _ref1;
      dendrite = {
        spines: [],
        length: 0,
        total_spines: 0,
    ...
    NeurolucidaXML.prototype.loadAxon = function(tag) {};
